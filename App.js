...
export default function App() {
  ...
  // Save all data whenever it changes
  useEffect(() => {
    if (!loaded) return;
    ...
    setData('books', books);
  }, [appData, team, prospects, dailyActions, earnings, books, loaded]);
    ...
    <>
      ...
      <NavigationContainer theme={darkTheme}>
        ...
        >
          <Tab.Screen
            name="HQ"
            options={{ tabBarIcon: ({ focused }) => <TabIcon icon="⌂" label="HQ" focused={focused} /> }}
          >
          ...
          <Tab.Screen
            name="NeoLife"
            options={{ tabBarIcon: ({ focused }) => <TabIcon icon="◈" label="NeoLife" focused={focused} /> }}
          >
          ...
          <Tab.Screen
            name="Pipeline"
            options={{ tabBarIcon: ({ focused }) => <TabIcon icon="◎" label="Pipeline" focused={focused} /> }}
          >
          ...
          <Tab.Screen
            name="Growth"
            options={{ tabBarIcon: ({ focused }) => <TabIcon icon="📈" label="Growth" focused={focused} /> }}
          >
          ...
          <Tab.Screen
            name="AI"
            options={{ tabBarIcon: ({ focused }) => <TabIcon icon="🧠" label="AI" focused={focused} /> }}
          >
            {() => <AIScreen />}
          </Tab.Screen>
        </Tab.Navigator>
